...
//! - SQLite BLOB storage (for self-hosted deployment)
...
/// Artwork service for managing poster/backdrop images (SQLite version)
#[cfg(feature = "sqlite")]
pub struct ArtworkService {
    db: Database,
    http_client: reqwest::Client,
...
/// Create the artwork bucket if it doesn't exist (PostgreSQL/Supabase)
#[cfg(feature = "postgres")]
