...
impl FileMatcher {
    ...
    pub async fn match_media_file(
        ...
        library: &crate::db::LibraryRecord,
    ...
    async fn try_match_episode_by_stored_metadata(
        ...
        let mut best_show: Option<(&crate::db::TvShowRecord, f64)> = None;
        for show in &shows {
    ...
    async fn try_match_movie_by_stored_metadata(
        ...
        let mut best_movie: Option<(&crate::db::MovieRecord, f64)> = None;
        for movie in &movies {
    ...
    async fn try_match_chapter_by_stored_metadata(
        ...
        let mut best_book: Option<(&crate::db::AudiobookRecord, f64)> = None;
    ...
    fn filter_albums_by_source<'a>(
        &self,
        source_name: &str,
        albums: &'a [crate::db::AlbumRecord],
    ) -> (Vec<&'a crate::db::AlbumRecord>, Vec<&'a crate::db::AlbumRecord>) {
