...
type MonitorType = "ALL" | "FUTURE" | "NONE";
type TvShowSettingsView = {
...
export function ShowSettingsModal({
  ...
  const [autoDownloadOverride, setAutoDownloadOverride] =
    useState<OverrideOption>("inherit");
  const [autoHuntOverride, setAutoHuntOverride] =
    useState<OverrideOption>("inherit");

  // Organization settings
  const [organizeFilesOverride, setOrganizeFilesOverride] =
    useState<OverrideOption>("inherit");
  const [renameStyleOverride, setRenameStyleOverride] =
    useState<RenameStyleOption>("inherit");
    ...
    if (show) {
      ...
      setAutoDownloadOverride(
        show.autoDownloadOverride === null
          ? "inherit"
          : show.autoDownloadOverride
            ? "enabled"
            : "disabled",
      );
      setAutoHuntOverride(
        show.autoHuntOverride === null
          ? "inherit"
          : show.autoHuntOverride
            ? "enabled"
            : "disabled",
      );
      ...
      setRenameStyleOverride(
        show.renameStyleOverride === null
          ? "inherit"
          : (show.renameStyleOverride as RenameStyleOption),
      );
  ...
  const handleSave = async () => {
    await onSave({
      ...
      autoDownloadOverride:
        autoDownloadOverride === "inherit"
          ? null
          : autoDownloadOverride === "enabled",
      autoHuntOverride:
        autoHuntOverride === "inherit" ? null : autoHuntOverride === "enabled",
      organizeFilesOverride:
        organizeFilesOverride === "inherit"
          ? null
          : organizeFilesOverride === "enabled",
      renameStyleOverride:
        renameStyleOverride === "inherit" ? null : renameStyleOverride,
      // Quality overrides
      allowedResolutionsOverride: isInheritingQuality
        ? null
        : qualitySettings.allowedResolutions,
      allowedVideoCodecsOverride: isInheritingQuality
        ? null
        : qualitySettings.allowedVideoCodecs,
      allowedAudioFormatsOverride: isInheritingQuality
        ? null
        : qualitySettings.allowedAudioFormats,
      requireHdrOverride: isInheritingQuality
        ? null
        : qualitySettings.requireHdr,
      allowedHdrTypesOverride: isInheritingQuality
        ? null
        : qualitySettings.allowedHdrTypes,
      allowedSourcesOverride: isInheritingQuality
        ? null
        : qualitySettings.allowedSources,
      releaseGroupBlacklistOverride: isInheritingQuality
        ? null
        : qualitySettings.releaseGroupBlacklist,
      releaseGroupWhitelistOverride: isInheritingQuality
        ? null
        : qualitySettings.releaseGroupWhitelist,
    });
  };
        ...
        <ModalBody className="gap-0">
          ...
          <div className="mb-4">
            ...
            <p className="text-xs text-default-500 mb-3">
              Control how episodes are monitored and downloaded
            </p>
          ...
          <div className="mb-4">
            ...
            <p className="text-xs text-default-500 mb-3">
              Control how files are organized and named
            </p>
          ...
          <div>
            ...
            <p className="text-xs text-default-500 mb-3">
              Control which releases are accepted
            </p>
            <QualitySettingsCard
